...
% Ensure dataTestPaths and labelsTest are of the same length
%assert(length(dataTestPaths) == length(labelsTest), 'Mismatch in lengths of dataTestPaths and labelsTest.');

% fprintf('labelsTest(idx): %d\n', labelsTest(idx));
% length(dataTestPaths)
% length(labelsTest)
